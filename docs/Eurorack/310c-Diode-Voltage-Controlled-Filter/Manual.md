...
*This is the web version of the manual. Click [here](Files/310c-Rev.1.docx) for the PDF version.*
...
This module **is/is not** reverse polarity protected. This means that the module will not/will get damaged if the power cable is plugged in backwards. However, a reversed power cable may still cause damage to the components in the module, as well as other modules connected to the same power supply. 
