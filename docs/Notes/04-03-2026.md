...
![(PLACEHOLDER) Simplest slew rate limiter](04-03-2026/simple-slew.png)

Minimoog style ADSR envelopes, gated AD/AR envelopes?
Basically bidirectional slew rate limiters (check above!)

![(PLACEHOLDER) Bidirectional slew](04-03-2026/bidirectional-slew.png)
...
Speaking of this, the common triangle/square lfos are also the same circuit, just with the resistor and capacitor values changed to have a lower frequency range. ([example](https://synthnerd.wordpress.com/2018/12/31/synth-diy-the-relaxation-lfo/))
